...
try {
  ...
  stage = "verify-supplier-stock";
  run("node", ["scripts/smoke-supplier-stock-postgres.mjs"], { DATABASE_URL: databaseUrl });
  ...
  console.log("✓ Supplier Mirror ingestion and stock-risk leases verified");
